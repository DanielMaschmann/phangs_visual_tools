...
for list_index in [1, 2]:
    ...
    best_model_file = '20221015_130309_out/%i_best_model.fits' % cluster_index

    fig = vh.plot_cigale_sed_results(cigale_flux_file_name='flux_file.dat',
                                     hdu_best_model_file_name=best_model_file,
                                     flux_fitted_model_file_name='20221015_130309_out/results.fits',
                                     ...
                                     hdu_number_hst=0, hdu_number_nircam='SCI', hdu_number_miri=0,
                                     filter_list=None, cigale_flux_file_col_name_ord=None, index_cigale_table=list_index-1,

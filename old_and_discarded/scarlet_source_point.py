...
cutout_dict.update(vh.indi_point_fit2cutout(img_file=file_name_jwst_f200w, cutout_pos=cutout_pos,
                                                 cutout_size=cutout_size, obs='jwst', hdu_number='SCI',
                                                 psf_file_name=psf_file_jwst_f200w, chan_name=channel_jwst_f200w,
                                                 fwhm_point=0.1, thresh_point=1,
                                                 fitting_steps=50, fitting_rel_err=1e-16, rescaling_factor=rescale_fact))
cutout_dict.update(vh.indi_point_fit2cutout(img_file=file_name_jwst_f300m, cutout_pos=cutout_pos,
                                                 cutout_size=cutout_size, obs='jwst', hdu_number='SCI',
                                                 psf_file_name=psf_file_jwst_f300m, chan_name=channel_jwst_f300m,
                                                 fwhm_point=0.1, thresh_point=1,
                                                 fitting_steps=50, fitting_rel_err=1e-16, rescaling_factor=rescale_fact))
cutout_dict.update(vh.indi_point_fit2cutout(img_file=file_name_jwst_f335m, cutout_pos=cutout_pos,
                                                 cutout_size=cutout_size, obs='jwst', hdu_number='SCI',
                                                 psf_file_name=psf_file_jwst_f335m, chan_name=channel_jwst_f335m,
                                                 fwhm_point=0.1, thresh_point=1,
                                                 fitting_steps=50, fitting_rel_err=1e-16, rescaling_factor=rescale_fact))
cutout_dict.update(vh.indi_point_fit2cutout(img_file=file_name_jwst_f360m, cutout_pos=cutout_pos,
                                                 cutout_size=cutout_size, obs='jwst', hdu_number='SCI',

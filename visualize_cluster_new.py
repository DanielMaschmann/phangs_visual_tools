...
cluster_list = np.genfromtxt('data/candidates_low_ci_.txt', skip_header=1)
...
fig.savefig('plot_output/new_embedded_cluster_%i.png' % cluster_index)
fig.savefig('plot_output/new_embedded_cluster_%i.pdf' % cluster_index)
